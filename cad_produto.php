    ...
    <main>
        <div class="success-page">
            <main>
                ...
                $preco = $_POST['preco'];
                $cor = $_POST['cor'];
                $sql = "INSERT INTO produtos(nome_produto, marca, modelo, ano_fabricacao, preco, cor) 
                    VALUES('$nome_produto','$marca','$modelo','$ano_fabricacao','$preco','$cor')";
                $con = mysqli_connect("127.0.0.1", "root", "", "banco_projetomotoxtreme");
                if (mysqli_connect_errno()) {
                    echo "Failed to connect to MySQL:" . mysqli_connect_error();
                }
                mysqli_query($con, $sql);
                echo "<div class='success-message'>Produto cadastrado com sucesso!</div>";
                mysqli_close($con);
                ?>
                <h2><a id="voltar-link" href="cadastra_produto.html">VOLTAR</a></h2>
            </main>
        </div>
    </main>
