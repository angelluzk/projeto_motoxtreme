...
<body>
    ...
    <div class="success-page">
            <main>
                ...
                $cargo = $_POST['cargo'];
                $sexo = $_POST['sexo'];
                $sql = "INSERT INTO funcionarios(nome, end, fone, cpf, email, dn, escolaridade, cargo, sexo) 
                    VALUES('$nome','$end','$fone','$cpf','$email','$dn','$escolaridade', '$cargo', '$sexo')";
                ...
                mysqli_close($con);
                ?>
                <h2><a id="voltar-link" href="cadastra_func.html">VOLTAR</a></h2>
            </main>
        </div>
    </main>
