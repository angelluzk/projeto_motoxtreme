...
<body>
    ...
    <main class="success-page">
        ...
        $dn = $_POST['dn'];
        $sexo = $_POST['sexo'];
        $sql = "update clientes set id='$id',nome='$nome',end='$end',fone='$fone',cpf='$cpf',email='$email',dn='$dn',sexo='$sexo' where id=$id";
        $con = mysqli_connect("127.0.0.1", "root", "", "banco_projetomotoxtreme");
        if (mysqli_connect_errno()) {
            echo "Failed to connect to MySQL: " . mysqli_connect_error();
        }
        mysqli_query($con, $sql);
        echo "<div class='success-message'>Cliente alterado com sucesso!</div>";
        mysqli_close($con);
        ?>
        <h2><a id="voltar-link" href="listar_cliente.php">VOLTAR</a></h2>
    </main>
